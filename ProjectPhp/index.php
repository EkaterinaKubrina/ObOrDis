...
<body>
    ...
    <div class="main-image">
		<img src="images/f.png" />
                ...
                <button type="submit" name="send" class="request" >Оставить заявку</button>
                </form>

    </div> 

   <div class="main-image3" align="center" >
    <br><p class = "main-text-header2"  align="center" > МЫ РАБОТАЕМ С ЛЮБЫМ ТИПОМ ПОМЕЩЕНИЙ! </p>
                <img src="images/квартиры.png" />
		<img src="images/дома.png" />
		<img src="images/рестораны.png" /><br>
                <img src="images/производство.png" />
		<img src="images/офисы.png" />
		<img src="images/школы.png" />
    </div> 
    ...
    <table>
               <tr> <td><img src="images/гарантия.png" /></td>
                <td><p class="text-block">Гарантия качества</p> </td> </tr>
               <tr> <td><img src="images/деньги.png" /></td>
                <td><p class="text-block">Цены от производителя</p></td>  </tr>
               <tr> <td><img src="images/работ.png" /></td>
